...
namespace ConsoleApp_MCP.Tools;
...
public sealed class WeatherTools
{
        ...
        [Description("The US state to get alerts for. Use the 2 letter abbreviation for the state (e.g. NY).")] string state)
    {
        ...
        return string.Join("\n--\n", alerts.Select(alert =>
        {
            ...
            return $"""
                    ...
                    Instruction: {(properties.TryGetProperty("instruction", out var instruction) ? instruction.GetString() : "No instructions provided.")}
                    """;
        }));
    }
        ...
        [Description("Longitude of the location.")] double longitude)
    {
        ...
        using var locationDocument = await JsonDocument.ParseAsync(await pointResponse.Content.ReadAsStreamAsync());
